...
static void desktop_multi_window_plugin_handle_method_call(
  ...
  if (strcmp(method, "createWindow") == 0) {
    ...
    auto isNotification = fl_value_get_bool(fl_value_lookup_string(args, "isNotification"));
    ...
    response = FL_METHOD_RESPONSE(fl_method_success_response_new(
      ...
      response = FL_METHOD_RESPONSE(fl_method_success_response_new(nullptr));
  } else if(strcmp(method, "setNewReact") == 0)  {
      auto *args = fl_method_call_get_args(method_call);
      auto window_id = fl_value_get_int(fl_value_lookup_string(args, "windowId"));
      auto width = fl_value_get_float(fl_value_lookup_string(args, "width"));
      auto height = fl_value_get_float(fl_value_lookup_string(args, "height"));
      ...
      auto *args = fl_method_call_get_args(method_call);
      auto window_id = fl_value_get_int(fl_value_lookup_string(args, "windowId"));
      auto opacity = fl_value_get_float(fl_value_lookup_string(args, "opacity"));
      MultiWindowManager::Instance()->SetOpacity(window_id, opacity);
      response = FL_METHOD_RESPONSE(fl_method_success_response_new(nullptr));
  } else if (strcmp(method, "setBoundsWithAnimation") == 0) {
      auto *args = fl_method_call_get_args(method_call);
      auto window_id = fl_value_get_int(fl_value_lookup_string(args, "windowId"));
      auto left = fl_value_get_float(fl_value_lookup_string(args, "left"));
      auto top = fl_value_get_float(fl_value_lookup_string(args, "top"));
      ...
      auto *args = fl_method_call_get_args(method_call);
      auto window_id = fl_value_get_int(fl_value_lookup_string(args, "windowId"));
      auto devicePixelRatio = fl_value_get_float(fl_value_lookup_string(args, "devicePixelRatio"));
      response = FL_METHOD_RESPONSE(MultiWindowManager::Instance()->GetBounds(window_id, devicePixelRatio));
